...
export type EvidenceClass =
  "owner_scenario" | "synthetic_fixture" | "synthetic_adversarial_fixture";
...
export interface ProviderStatusDto {
  readonly credentialPersistence?: "session" | "os_encrypted";
...
export interface CodexHostStatusDto {
  ...
  readonly capabilities: {
    readonly start: CodexCapabilityStateDto;
    readonly structuredOutput: CodexCapabilityStateDto;
    readonly mcp: CodexCapabilityStateDto;
    readonly readOnlySandbox: CodexCapabilityStateDto;
    readonly cancellation: CodexCapabilityStateDto;
    readonly contextIsolation: CodexCapabilityStateDto;
  };
  readonly configurationSeparateFromVerification: true;
}

export type ClosedExternalAppPilotStatusDto =
  | "draft"
  | "preflight_ready"
...
export interface ClosedPilotAttemptDto {
  readonly id: string;
  ...
  readonly usage?: Readonly<Record<string, number>> | "unavailable";
}
export interface ClosedPilotCandidateDto {
  readonly id: string;
...
export interface ClosedExternalAppPilotDto {
  ...
  readonly episode: { readonly id: string; readonly version: number };
  readonly currentTask: string;
  readonly evidenceClass:
    "synthetic_fixture" | "owner_operated_closed_host_observation";
  readonly status: ClosedExternalAppPilotStatusDto;
  readonly version: number;
  ...
  readonly preflight?: CodexHostStatusDto;
  readonly manifests: readonly ClosedPilotManifestDto[];
  readonly attempts: readonly ClosedPilotAttemptDto[];
  readonly candidate?: ClosedPilotCandidateDto;
  readonly review?: {
...
export interface ClosedPilotImportDto {
  readonly pilot: ClosedExternalAppPilotDto;
  readonly revision: Readonly<Record<string, unknown>>;
  readonly review: PreparedReviewDto;
}
export interface ClosedPilotReviewRestoreDto {
  readonly pilot: ClosedExternalAppPilotDto;
  readonly review: PreparedReviewDto;
}
export interface ClosedPilotDispositionDto {
  readonly pilot: ClosedExternalAppPilotDto;
  readonly receipt: ResearchRoomReceiptDto;
}
export interface ClosedPilotEvidenceDto {
  readonly schemaVersion: "1.0.0";
  readonly evidenceClass:
    "synthetic_fixture" | "owner_operated_closed_host_observation";
  readonly host: "codex";
  ...
  readonly stableOutcome: ClosedExternalAppPilotStatusDto;
  ...
  readonly context: readonly {
    ...
    readonly selectedWorkingMemoryCount: number;
  }[];
...
export type SelectedDirectoryPreviewDto =
  ...
  | ({
      ...
      readonly initializationRequired: false;
...
export interface ContextManifestDto {
  ...
  readonly workingMemory?: {
    ...
    readonly excluded: readonly {
      readonly itemId: string;
      readonly state: ProjectMemoryStateDto;
      readonly reason: ProjectMemoryManifestExclusionReasonDto;
    }[];
  };
...
export interface DecisionDetailDto extends DecisionSummaryDto {
  readonly availableActions: readonly (
    "accept" | "reject" | "freeze" | "supersede"
  )[];
...
export interface IssueDetailDto extends IssueSummaryDto {
  ...
  readonly reopenHistory: readonly unknown[];
  readonly timeline: readonly unknown[];
  readonly relatedBriefVersionIds: readonly string[];
...
export interface EvidenceSummaryDto {
  ...
  readonly inferenceCapacity: string;
  readonly artifactId?: string;
  readonly revisionId?: string;
  readonly version: number;
  readonly provenance: ProvenanceDto;
}
export interface EvidenceDetailDto extends EvidenceSummaryDto {
  readonly contentVersionHash?: string;
  readonly safeLocator: Readonly<Record<string, unknown>>;
  ...
  readonly claimLinks: readonly unknown[];
  readonly mechanismLinks: readonly unknown[];
  readonly relatedBriefVersionIds: readonly string[];
  readonly relatedDecisionIds: readonly string[];
  readonly relatedIssueIds: readonly string[];
  readonly relatedEpisodeIds: readonly string[];
...
export interface EpisodeDetailDto extends EpisodeSummaryDto {
  readonly lockedStart: Readonly<Record<string, unknown>>;
  ...
  readonly timeline: readonly unknown[];
  readonly lockedBrief?: {
    readonly versionId: string;
    readonly stage: string;
    readonly task: string;
  };
  readonly argumentDeltas: readonly {
    readonly receiptId: string;
    readonly kind: string;
    readonly summary: string;
  }[];
...
export interface ObjectReceiptSummaryDto {
  ...
  readonly disposition: Readonly<Record<string, unknown>>;
...
export interface ObjectReceiptDetailDto extends ObjectReceiptSummaryDto {
  readonly countsAsExternalEvidence: false;
  readonly ledgerOnlyReason?: string;
  readonly suggestionHash: string;
  readonly argumentDelta: Readonly<Record<string, unknown>>;
  readonly findings: readonly unknown[];
  readonly alternativeExplanations: readonly string[];
  readonly unknowns: readonly string[];
  readonly unproven: readonly string[];
  readonly minimalCorrection: string;
  readonly contextFields: readonly unknown[];
  ...
  readonly correctionAppeals: readonly {
    ...
    readonly status: CorrectionAppealStatusDto;
    readonly updatedAt: string;
...
export type CorrectionAppealStatusDto =
  | "draft"
  | "recorded"
...
export interface AppealStatementDto {
  ...
  readonly desiredDisposition?: AppealResolutionKindDto;
}
...
export interface AppealManifestObjectDto {
...
export interface AppealManifestDto {
  ...
  readonly includedObjects: readonly AppealManifestObjectDto[];
  readonly excludedFields: readonly string[];
  readonly tokenEstimate: Readonly<Record<string, unknown>>;
  readonly costEstimate: Readonly<Record<string, unknown>>;
  readonly stateBindingHash: string;
}
export interface AppealAttemptDto {
  readonly id: string;
  readonly ordinal: number;
  readonly status:
    "prepared" | "running" | "completed" | "failed" | "cancelled" | "unknown";
  readonly participant: Readonly<Record<string, unknown>>;
  readonly independenceBasis: Readonly<Record<string, unknown>>;
  readonly manifest: AppealManifestDto;
  readonly confirmationNonce: string;
...
export interface PreparedAppealSecondOpinionDto {
  readonly schemaVersion: "1.0.0";
  readonly contextManifestVisible: true;
  readonly appeal: AppealDetailDto;
  readonly attemptId: string;
  readonly confirmationNonce: string;
  readonly manifest: AppealManifestDto;
...
export type DeliberationRoomStatusDto =
  | "draft"
  | "context_prepared"
  ...
  | "resolved"
  | "closed";
export interface DeliberationSourceDto {
  readonly projectId: string;
  readonly kind:
    | "correction_appeal"
    | "research_issue"
...
export interface DeliberationParticipantStateDto {
  readonly slot: "a" | "b";
  readonly providerId: string;
  readonly model: string;
  readonly status: string;
}
export interface DeliberationParticipantDto {
  readonly id: string;
  readonly slot: "a" | "b";
...
export interface DeliberationManifestDto {
  readonly schemaVersion: "1.0.0";
  ...
  readonly includedFields: readonly string[];
  readonly includedObjects: readonly Readonly<Record<string, unknown>>[];
  readonly excludedFields: readonly string[];
  readonly stateBindingHash: string;
  readonly protocol: Readonly<Record<string, string>>;
  readonly prompt: Readonly<Record<string, string>>;
  readonly responseSchema: Readonly<Record<string, string>>;
...
export interface DeliberationAssessmentDto {
  readonly assessment: "support" | "oppose" | "mixed" | "unknown";
  readonly directAnswer: string;
  readonly dimensions: readonly Readonly<Record<string, unknown>>[];
  readonly claims: readonly Readonly<Record<string, unknown>>[];
  readonly evidenceSpans: readonly Readonly<Record<string, unknown>>[];
...
export interface DeliberationAttemptDto {
  ...
  readonly cancelledAt?: string;
  readonly failure?: string;
  readonly assessment?: DeliberationAssessmentDto;
}
...
export interface DeliberationRetryDto {
  readonly id: string;
  readonly participantId: string;
  readonly priorAttemptId: string;
  readonly status:
    "prepared" | "running" | "completed" | "failed" | "cancelled" | "unknown";
  readonly manifest: DeliberationManifestDto;
  readonly attempt: DeliberationAttemptDto;
  readonly userConfirmed: boolean;
  readonly preparedAt: string;
  readonly startedAt?: string;
  readonly completedAt?: string;
}
export interface DeliberationRoomSummaryDto {
  readonly kind: "deliberation_room";
  readonly id: string;
  readonly title: string;
  readonly status: DeliberationRoomStatusDto;
  ...
  readonly participantStates: readonly [
    DeliberationParticipantStateDto,
    DeliberationParticipantStateDto,
  ];
...
export interface DeliberationRoomDetailDto extends DeliberationRoomSummaryDto {
  ...
  readonly assessments: readonly DeliberationAttemptDto[];
  readonly reveal?: {
    readonly mode: "complete" | "partial" | "cancelled";
    readonly explicitUserAction: true;
    readonly revealedAt: string;
  };
  readonly differenceSummary?: DeliberationDifferenceSummaryDto;
  readonly challenge?: {
    readonly id: string;
    readonly question: string;
    readonly status: string;
  ...
  readonly retry?: DeliberationRetryDto;
  readonly manualExternalOpinions: readonly ManualExternalOpinionDto[];
  readonly resolutions: readonly Readonly<Record<string, unknown>>[];
  readonly trace: readonly {
    readonly step: string;
    readonly summary: string;
...
export interface PreparedDeliberationDto {
  ...
  readonly room: DeliberationRoomDetailDto;
  readonly manifests: readonly [
    DeliberationManifestDto,
    DeliberationManifestDto,
  ];
...
export interface PreparedDeliberationRetryDto {
  readonly schemaVersion: "1.0.0";
  readonly contextManifestVisible: true;
  readonly room: DeliberationRoomDetailDto;
  readonly manifest: DeliberationManifestDto;
...
export interface BriefVersionDto {
  ...
  readonly fixedDecisions: readonly unknown[];
  readonly allowedChanges: readonly unknown[];
  readonly forbiddenChanges: readonly unknown[];
  readonly expectedDeltas: readonly unknown[];
  readonly evidenceBoundaries: readonly unknown[];
  readonly explicitNonGoals: readonly string[];
  readonly source: Readonly<Record<string, unknown>>;
  readonly createdAt: string;
  readonly supersedes?: string;
}
export interface BriefCandidateDto {
  readonly id: string;
  ...
  readonly impact: {
    ...
    readonly evidenceBoundaryEffect:
      "loosened" | "tightened" | "changed" | "unchanged";
    ...
    readonly manifestImpact: string;
    readonly expectedEntityVersion: number;
  };
}
export interface BriefWorkspaceDto {
  readonly schemaVersion: "1.0.0";
  readonly projectId: string;
  readonly briefId: string;
  readonly entityVersion: number;
  readonly active: BriefVersionDto;
  readonly versions: readonly BriefVersionDto[];
  readonly versionCount: number;
  readonly versionsTruncated: boolean;
  readonly candidates: readonly BriefCandidateDto[];
...
export interface ProjectOverviewDto {
  ...
  readonly providerStatus: "configured" | "ledger_only";
  readonly brief: {
    readonly id: string;
    readonly versionId: string;
    readonly versionNumber: number;
  ...
  readonly counts: {
    ...
    readonly deliberationRooms: number;
  };
  readonly statuses: {
  ...
  readonly attention: {
    readonly total: number;
    readonly top: readonly AttentionItemDto[];
  };
...
export interface ResearchObjectSearchResultDto {
  readonly kind: ResearchObjectKind | "brief" | "memory" | "external_app_pilot";
  readonly id: string;
  readonly title: string;
...
export interface ResearchObjectSearchDto {
  readonly schemaVersion: "1.0.0";
  readonly projectId: string;
  readonly datasetVersion: string;
  readonly query: string;
  readonly items: readonly ResearchObjectSearchResultDto[];
  readonly nextCursor?: string;
  readonly truncated: boolean;
}

export type ProjectMemoryKindDto =
  "term" | "working_hint" | "resume_note" | "workset";
export type ProjectMemoryStateDto =
  "candidate" | "active" | "stale" | "expired" | "retired" | "forgotten";
export type ProjectMemoryManifestExclusionReasonDto =
  | "not_selected"
...
export type ProjectMemorySensitivityDto =
  "public" | "project_private" | "sensitive" | "secret_never_send";
export type ProjectMemoryOutboundPolicyDto =
  "never_send" | "explicit_manifest_only";
export type ProjectMemoryObjectKindDto =
  | "brief"
  | "decision"
  | "issue"
  | "evidence"
  ...
  | "artifact"
  | "revision";
export type ProjectMemoryContentDto =
  | { readonly term: string; readonly definition: string }
  | { readonly text: string }
  | {
      readonly purpose: string;
      readonly refs: readonly {
        readonly kind: ProjectMemoryObjectKindDto;
        readonly id: string;
        readonly version: number;
      }[];
    };
export type ProjectMemorySourceDto =
  | { readonly kind: "direct_user"; readonly actorId: string }
  | {
      readonly kind: "project_object";
      readonly objectKind: ProjectMemoryObjectKindDto;
      readonly objectId: string;
      readonly objectVersion: number;
      readonly contentFingerprint: string;
    };
export type ProjectMemoryRetentionDto =
...
export interface ProjectMemoryTransitionDto {
  readonly action:
    | "created"
    | "confirmed"
    | "edited"
    ...
    | "renewed"
    | "retired";
  readonly from?: Exclude<ProjectMemoryStateDto, "forgotten">;
  readonly to: Exclude<ProjectMemoryStateDto, "forgotten">;
...
export interface ProjectMemoryItemDto {
  ...
  readonly source?: ProjectMemorySourceDto;
  ...
  readonly staleReason?:
    "source_version_changed" | "source_content_changed" | "source_unavailable";
  readonly createdAt?: string;
  readonly updatedAt?: string;
  readonly confirmedAt?: string;
  ...
  readonly transitions?: readonly ProjectMemoryTransitionDto[];
}
export interface ResumeCheckpointDto {
  readonly schemaVersion: "1.0.0";
  readonly id: string;
  readonly projectId: string;
  readonly authorityClass: "resume_checkpoint_non_authoritative";
  readonly projectVersion: number;
  readonly authorityBindings: readonly {
    readonly kind: string;
    readonly id: string;
    readonly version: number;
  }[];
  readonly memoryBindings: readonly {
    readonly id: string;
    readonly version: number;
    readonly state: ProjectMemoryStateDto;
  }[];
...
export type ResumeAuthorityBindingKindDto =
  | "project"
  | "brief"
  | "decision"
  | "issue"
...
export type ResumeAuthorityChangeDto =
  | {
      ...
      readonly kind: ResumeAuthorityBindingKindDto;
      readonly id: string;
...
export type ResumeWorkingMemoryChangeDto =
  | {
      ...
      readonly id: string;
      readonly afterVersion: number;
      readonly afterState: ProjectMemoryStateDto;
    }
  | {
      readonly change: "updated";
      readonly id: string;
      readonly beforeVersion: number;
      readonly afterVersion: number;
      readonly beforeState: ProjectMemoryStateDto;
      readonly afterState: ProjectMemoryStateDto;
    }
  | {
      readonly change: "removed";
...
export interface ResumeChangesDto {
  readonly projectChanged: boolean;
  readonly authority: readonly ResumeAuthorityChangeDto[];
  readonly workingMemory: readonly ResumeWorkingMemoryChangeDto[];
...
export interface ProjectMemoryProjectionDto {
  ...
  readonly projectState: {
    ...
    readonly activeAppeals: readonly {
      readonly id: string;
      readonly status: string;
      readonly version: number;
    }[];
    readonly activeDeliberations: readonly {
      readonly id: string;
      readonly status: string;
      readonly version: number;
    }[];
    readonly recentReceipt?: {
      readonly id: string;
      readonly status: string;
      readonly version: number;
    };
  ...
  readonly workingMemory: {
    readonly authorityClass: "working_memory_non_authoritative";
    readonly items: readonly ProjectMemoryItemDto[];
  ...
  readonly resume: {
    readonly authorityClass: "resume_checkpoint_non_authoritative";
    readonly checkpoint?: ResumeCheckpointDto;
    readonly changes?: ResumeChangesDto;
