...
export interface AttentionItemDto { readonly id: string; readonly kind: "brief_candidate" | "decision" | "issue" | "episode" | "review" | "manifest" | "rollback" | "provider" | "appeal" | "deliberation_room"; readonly title: string; readonly reason: string; readonly severity: "high" | "normal"; readonly href: string; readonly primaryAction: string; readonly sourceObject: { readonly kind: string; readonly id: string }; readonly valid: true; readonly createdAt: string; }
