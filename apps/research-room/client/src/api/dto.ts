...
export interface AttentionItemDto { readonly id: string; readonly kind: "brief_candidate" | "decision" | "issue" | "episode" | "review" | "manifest" | "rollback" | "provider"; readonly title: string; readonly reason: string; readonly severity: "high" | "normal"; readonly href: string; readonly primaryAction: string; readonly sourceObject: { readonly kind: string; readonly id: string }; readonly valid: true; readonly createdAt: string; }
...
export interface ProjectOverviewDto { readonly schemaVersion: "1.0.0"; readonly project: { readonly id: string; readonly title: string; readonly version: number; readonly updatedAt: string }; readonly providerStatus: "configured" | "ledger_only"; readonly brief: { readonly id: string; readonly versionId: string; readonly versionNumber: number; readonly question: string; readonly stage: string; readonly task: string }; readonly counts: { readonly decisions: number; readonly issues: number; readonly evidence: number; readonly episodes: number; readonly receipts: number }; readonly statuses: { readonly decisions: Readonly<Record<string, number>>; readonly issues: Readonly<Record<string, number>>; readonly evidence: Readonly<Record<string, number>>; readonly episodes: Readonly<Record<string, number>>; readonly receipts: Readonly<Record<string, number>> }; readonly attention: { readonly total: number; readonly top: readonly AttentionItemDto[] }; readonly currentEpisode?: { readonly id: string; readonly status: string; readonly updatedAt: string; readonly href: string }; readonly latestReceipt?: { readonly id: string; readonly status: string; readonly disposition: string; readonly updatedAt: string; readonly href: string }; readonly recentChanges: readonly { readonly kind: ResearchObjectKind | "brief"; readonly id: string; readonly label: string; readonly status: string; readonly at: string; readonly href: string }[]; }
