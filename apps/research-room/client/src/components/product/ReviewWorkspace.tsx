...
export function ReviewWorkspace(props: ReviewWorkspaceProps) {
  ...
  return <section className="review-workspace" aria-labelledby="review-heading">
    <header className="workspace-section-header"><div><p className="eyebrow">REVIEW ROOM / ACTIVE</p><h1 id="review-heading">{t(props.language, "research_room")}</h1><p>{t(props.language, "room_deck")}</p></div><StatusBadge tone="neutral">{t(props.language, "proposal_only")}</StatusBadge></header>
