...
export interface TransitionDecisionCommand { readonly projectId: string; readonly decisionId: string; readonly actor: ResearchActor; readonly target: Extract<DecisionStatus, "accepted" | "rejected" | "frozen">; readonly reason: string; readonly expectedVersion?: number; }
export interface SupersedeDecisionCommand { readonly projectId: string; readonly decisionId: string; readonly actor: ResearchActor; readonly statement: string; readonly scope: DecisionScope; readonly rationale: string; readonly effectiveBriefVersionId: string; readonly reopenConditions: readonly string[]; readonly reason: string; readonly expectedVersion?: number; }
...
export interface ResolveIssueCommand { readonly projectId: string; readonly issueId: string; readonly actor: ResearchActor; readonly reason: string; readonly resolutionEvidenceId: string; readonly expectedVersion?: number; }
export interface WaiveIssueCommand { readonly projectId: string; readonly issueId: string; readonly actor: ResearchActor; readonly scope: DecisionScope; readonly reason: string; readonly invalidationCondition?: string; readonly expectedVersion?: number; }
export interface DisputeIssueCommand { readonly projectId: string; readonly issueId: string; readonly actor: ResearchActor; readonly reason: string; readonly expectedVersion?: number; }
export interface ReopenIssueCommand { readonly projectId: string; readonly issueId: string; readonly actor: ResearchActor; readonly reason: string; readonly context: IssueReopenContext; readonly expectedVersion?: number; }
