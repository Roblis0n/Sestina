...
export enum SestinaErrorCode {
  ...
  collaboration_endpoint_not_found = "collaboration_endpoint_not_found",
...
const STATUS_MAP: Record<SestinaErrorCode, number> = {
  ...
  [SestinaErrorCode.assertion_not_found]: 404,
  [SestinaErrorCode.evidence_not_found]: 404,
  [SestinaErrorCode.claim_not_found]: 404,
  [SestinaErrorCode.deliverable_not_found]: 404,
  ...
  [SestinaErrorCode.collaboration_endpoint_not_found]: 404,
  ...
  [SestinaErrorCode.database_unavailable]: 503,
