...
try {
  ...
  if (value.researchRoomOfflineVerified !== true || value.loopbackPolicy !== true || value.providerConfigured !== false || value.networkAttempts !== 0 || value.backgroundArtifacts !== 0) throw new Error("offline result contract drifted");
