...
function runNode(label, args) {
  ...
  if (result.error || result.status !== 0) {
    process.stderr.write("[RI-53 shared] failed: " + label + "\n");
...
run("RI-53 production-source lint", eslint, [
  "apps/cli/src/main.ts",
  "apps/research-room/src/main.ts",
  "apps/research-room/src/server.ts",
  "apps/research-room/client/src/api/client.ts",
  "apps/research-room/client/src/api/decoders.ts",
  "apps/research-room/client/src/api/dto.ts",
  "apps/research-room/client/src/app/App.tsx",
  "apps/research-room/client/src/components/product/AppChrome.tsx",
  "apps/research-room/client/src/components/product/RecoveryDialog.tsx",
  "apps/research-room/client/src/screens/ProjectShell.tsx",
...
run("release, recovery, upgrade, security, and authority tests", vitest, [
  "run",
  "--project",
  "unit",
...
for (const script of [
  ...
  "scripts/prepare-ri53-lifecycle-fixture.mjs",
  "scripts/build-release.mjs",
  "scripts/lib/release-verifier.mjs",
  "scripts/no-network-preload.mjs",
]) {
...
process.stdout.write("\n[RI-53 shared] all deterministic gates passed\n");
